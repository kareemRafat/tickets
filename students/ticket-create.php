            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex items-center gap-3 bg-white dark:bg-gray-800/50 rounded-xl p-3.5 border border-blue-50 dark:border-blue-900/20 shadow-sm">
                    <div class="flex-shrink-0 w-10 h-10 bg-blue-50 dark:bg-blue-800/40 rounded-lg flex items-center justify-center">
                        <svg class="w-5 h-5 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20"><path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 5a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 13a8.949 8.949 0 0 1-4.951-1.488A3.987 3.987 0 0 1 9 13h2a3.987 3.987 0 0 1 3.951 3.512A8.949 8.949 0 0 1 10 18Z"/></svg>
                    </div>
                    <div>
                ...
                <div class="flex items-center gap-3 bg-white dark:bg-gray-800/50 rounded-xl p-3.5 border border-blue-50 dark:border-blue-900/20 shadow-sm">
                    <div class="flex-shrink-0 w-10 h-10 bg-blue-50 dark:bg-blue-800/40 rounded-lg flex items-center justify-center">
                        <svg class="w-5 h-5 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20"><path d="M18 0H2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2ZM6 6a2 2 0 1 1 4 0 2 2 0 0 1-4 0Zm8 10v1H6v-1a3 3 0 0 1 3-3h2a3 3 0 0 1 3 3Zm2-9a1 1 0 0 1-1 1H9a1 1 0 0 1 0-2h6a1 1 0 0 1 1 1Zm0 4a1 1 0 0 1-1 1H9a1 1 0 0 1 0-2h6a1 1 0 0 1 1 1Z"/></svg>
                    </div>
                    <div>
