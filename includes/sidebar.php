   ...
   <div class="h-full py-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <?php else: ?>
            ...
            <li>
               <a href="<?php echo BASE_URL; ?>students/login.php" class="flex items-center py-2.5 pe-0 ps-2.5 text-gray-900  dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group text-sm transition-all <?php echo $current_page === 'login' ? $active_classes : ''; ?>">
