...
<head>
    ...
    <!-- Google Fonts: Plus Jakarta Sans for a clean, premium look -->
        ...
        <div class="px-4 py-3 lg:px-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="<?php echo BASE_URL; ?>" class="flex ml-2 md:mr-24">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                            <div class="px-4 py-3" role="none">
                                ...
                                <span class="inline-flex items-center px-2 py-0.5 mt-2 text-xs font-medium rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200">
                                    <?php echo htmlspecialchars(ucfirst($_SESSION['user_role'] ?? 'Guest')); ?>
                                </span>
                            </div>
                            <div class="py-1" role="none">
                                ...
                                ?>
                                <a href="<?php echo $logout_url; ?>" class="block px-4 py-2 text-sm text-red-600 hover:bg-gray-100 dark:text-red-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Sign out</a>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
