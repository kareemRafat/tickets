...
$branches = [];
try {
    $stmt = $db->query("SELECT * FROM branches ORDER BY id ASC");
                ...
                <div class="px-6 py-6 lg:px-8 text-right">
                    ...
                    <form class="space-y-4" action="" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="مثال: فرع القاهرة" required>
                        </div>
                        <div>
                            <label for="code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">رمز الفرع المختصر (Code)</label>
                            <input type="text" name="code" id="code" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white font-mono uppercase" placeholder="مثال: CAI" required>
                        </div>
                        <div>
