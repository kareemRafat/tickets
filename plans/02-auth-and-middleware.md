...
This plan details the implementation of employee and admin authentication, student verification based on National ID, and security layers. **Note: All user-facing interfaces (login pages, verification screens, error alerts, forms, etc.) must be built in Arabic (RTL) only.**
...
- [x] **Task 1.1: Create Security Utilities Manager**
...
- [x] **Task 1.2: Build Core Authentication Gatekeeper**
...
- [x] **Task 1.3: Rate Limiting & Secure Headers**
...
- [x] **Task 2.1: Unified or Separate Login Portals**
...
- [x] **Task 2.2: Login Controller Logic**
...
- [x] **Task 3.1: Student Gatekeeper Screen**
...
- [x] **Task 3.2: Verify National ID Logic**
